...
from activation import SymbolicActivation
...
if __name__ == "__main__":
    ...
    results['Symbolic'] = run_experiment("Symbolic", SymbolicActivation(alpha=1.0))

    # 🔹 Plot Results
    plt.bar(results.keys(), results.values())
    plt.ylabel("Accuracy")
    plt.title("Activation Function Comparison")
    plt.savefig("plots/activation_comparison.png")
    print("Saved plot to plots/activation_comparison.png")
